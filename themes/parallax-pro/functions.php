...
function parallax_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'parallax-google-fonts', '//fonts.googleapis.com/css?family=Dosis|Kelly+Slab', array(), CHILD_THEME_VERSION );
...
add_theme_support( 'genesis-style-selector', array(
	...
	'parallax-pro-custom'   => __( 'Parallax Pro Custom', 'parallax' ),
) );
